    ...
    <div class="d-grid gap-3 d-grid-template-1fr-19">
        <div class="card group-box mb-0">
            ...
            <div class="card-body text-center">
                <div class="group-icon">
                    <img src="../assets/images/page-img/gi-1.jpg" alt="profile-img"
                        class="rounded-2 img-fluid avatar-90 border border-4" loading="lazy"/>
                </div>
                <div class="group-info mt-3 mb-2">
                    <a href="group-detail.html" class="h4">Designer</a>
                </div>
                ...
                <div class="group-member mb-4">
                    <div class="iq-media-group">
                        <a href="#" class="iq-media">
                            <img class="img-fluid avatar-30 rounded-circle" src="../assets/images/user/05.jpg"
                                alt="" loading="lazy"/>
                        </a>
                        <a href="#" class="iq-media">
                            <img class="img-fluid avatar-30 rounded-circle" src="../assets/images/user/06.jpg"
                                alt="" loading="lazy"/>
                        </a>
                        <a href="#" class="iq-media">
                            <img class="img-fluid avatar-30 rounded-circle" src="../assets/images/user/07.jpg"
                                alt="" loading="lazy"/>
                        </a>
                        <a href="#" class="iq-media">
                            <img class="img-fluid avatar-30 rounded-circle" src="../assets/images/user/08.jpg"
                                alt="" loading="lazy"/>
                        </a>
                        <a href="#" class="iq-media">
                            <img class="img-fluid avatar-30 rounded-circle" src="../assets/images/user/09.jpg"
                                alt="" loading="lazy"/>
                        </a>
                        <a href="#" class="iq-media">
                            <img class="img-fluid avatar-30 rounded-circle" src="../assets/images/user/10.jpg"
                                alt="" loading="lazy"/>
                        </a>
                    </div>
                </div>
        ...
        <div class="card group-box mb-0">
            ...
            <div class="card-body text-center">
                ...
                <div class="group-info mt-3 mb-2">
                    <a href="group-detail.html" class="h4">R & D</a>
                </div>
                <div class="group-details pb-4 mb-4 border-bottom">
                    <ul class="d-flex align-items-center justify-content-center list-inline m-0 p-0 gap-3">
                        <li>
        ...
        <div class="card group-box mb-0">
            ...
            <div class="card-body text-center">
                ...
                <div class="group-info mt-3 mb-2">
                    <a href="group-detail.html" class="h4">Graphics</a>
                </div>
                <div class="group-details pb-4 mb-4 border-bottom">
                    <ul class="d-flex align-items-center justify-content-center list-inline m-0 p-0 gap-3">
                        <li>
        ...
        <div class="card group-box mb-0">
            ...
            <div class="card-body text-center">
                ...
                <div class="group-info mt-3 mb-2">
                    <a href="group-detail.html" class="h4">Developer</a>
                </div>
                <div class="group-details pb-4 mb-4 border-bottom">
                    <ul class="d-flex align-items-center justify-content-center list-inline m-0 p-0 gap-3">
                        <li>
        ...
        <div class="card group-box mb-0">
            ...
            <div class="card-body text-center">
                ...
                <div class="group-info mt-3 mb-2">
                    <a href="group-detail.html" class="h4">Tester</a>
                </div>
                <div class="group-details pb-4 mb-4 border-bottom">
                    <ul class="d-flex align-items-center justify-content-center list-inline m-0 p-0 gap-3">
                        <li>
        ...
        <div class="card group-box mb-0">
            ...
            <div class="card-body text-center">
                ...
                <div class="group-info mt-3 mb-2">
                    <a href="group-detail.html" class="h4">Events</a>
                </div>
                <div class="group-details pb-4 mb-4 border-bottom">
                    <ul class="d-flex align-items-center justify-content-center list-inline m-0 p-0 gap-3">
                        <li>
        ...
        <div class="card group-box">
            ...
            <div class="card-body text-center">
                ...
                <div class="group-info mt-3 mb-2">
                    <a href="group-detail.html" class="h4">Coder</a>
                </div>
                <div class="group-details pb-4 mb-4 border-bottom">
                    <ul class="d-flex align-items-center justify-content-center list-inline m-0 p-0 gap-3">
                        <li>
        ...
        <div class="card group-box">
            ...
            <div class="card-body text-center">
                ...
                <div class="group-info mt-3 mb-2">
                    <a href="group-detail.html" class="h4">Themes</a>
                </div>
                <div class="group-details pb-4 mb-4 border-bottom">
                    <ul class="d-flex align-items-center justify-content-center list-inline m-0 p-0 gap-3">
                        <li>
        ...
        <div class="card group-box">
            ...
            <div class="card-body text-center">
                ...
                <div class="group-info mt-3 mb-2">
                    <a href="group-detail.html" class="h4">Review</a>
                </div>
                <div class="group-details pb-4 mb-4 border-bottom">
                    <ul class="d-flex align-items-center justify-content-center list-inline m-0 p-0 gap-3">
                        <li>
